...
import { getAboutMe } from '../apis/authService';
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
              Highly skilled and motivated Full Stack Developer with a comprehensive understanding of the entire web development process. Equipped with a strong foundation in both front-end and back-end technologies, adept at designing, implementing, and maintaining robust and scalable web applications. Passionate about staying up-to-date with the latest industry trends and technologies to deliver cutting-edge solutions.
              </p>
            </div>

            <div className="mx-auto max-w-180 mt-4.5 mb-5.5">
              <h4 className="font-semibold text-black dark:text-white">
                Phone
              </h4>
              <p className="mt-4.5">
