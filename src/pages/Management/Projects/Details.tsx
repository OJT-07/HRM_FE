...
import ProjectTimeLine from './Timelines/Timeline.jsx';
...
const EmployeesList = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      console.log(
        '🚀 ~ file: Details.tsx:49 ~ fetchData ~ response.data.data.employeeInProject:',
        response.data.data.employeeInProject
      );
